//
// Generated file, do not edit! Created by opp_msgc 4.2 from messages/SyncPkt.msg.
//
...
SyncPkt::SyncPkt(const SyncPkt& other) : cPacket(other)
{
    copy(other);
}
...
void SyncPkt::copy(const SyncPkt& other)
{
...
void SyncPkt::setSequenceId(int sequenceId)
{
...
void SyncPkt::setSrcAddr(int srcAddr)
{
...
void SyncPkt::setStatus(int8 status)
{
...
void SyncPkt::setPosX(int16 posX)
{
    this->posX_var = posX;
}
...
void SyncPkt::setPosY(int16 posY)
{
    this->posY_var = posY;
}
...
void SyncPkt::setPosZ(int16 posZ)
{
    this->posZ_var = posZ;
}
...
void SyncPkt::setTimestamp(int32 timestamp)
{
